...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:mydbrocks@localhost/wordpress?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://root:mydbrocks@localhost/civicrm?new_link=true' );
}
...
$civicrm_root = 'C:\\code\\xampp\\htdocs\\test\\php\\wordpress/wp-content/plugins\\civicrm\\civicrm\\';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:\\code\\xampp\\htdocs\\test\\php\\wordpress/wp-content/plugins\\files\\civicrm\\templates_c\\' );
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/test/php/wordpress/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '87885d370329a45c1aedf19cf9c319f9' );
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:\\code\\xampp\\htdocs\\test\\php\\wordpress/wp-content/plugins\\files\\civicrm\\templates_c\\/mail.log' );
// }
